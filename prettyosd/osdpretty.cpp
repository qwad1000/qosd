...
const int OSDPretty::kMaxIconSize = 50;
    ...
    fader_(new QTimeLine(300, this))
{
  ...
  QImage shadow_edge(":/images/osd_shadow_edge.png");
  QImage shadow_corner(":/images/osd_shadow_corner.png");
  for (int i=0 ; i<4 ; ++i) {
  ...
  background_ = QPixmap(":/images/osd_background.png");
...
void OSDPretty::Load() {
  ...
  background_color_ = QColor(s.value("background_color", kPresetOrange).toInt());
